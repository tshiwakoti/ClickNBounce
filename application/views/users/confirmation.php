...
<head>
  ...
  function initialize() {
    ...
    map.controls[google.maps.ControlPosition.TOP_CENTER].push(
      ...
      marker2 = new google.maps.Marker({
        map: map,
        draggable: true,
        position: new google.maps.LatLng( 52.8566140, -12.35222190)
      });
  ...
  searchControl.addSearcher(new google.search.WebSearch("californa"));
  ...
  <div id="searchcontrol"></div>
      ...
      <div id = "confirmation">
        <a id = "packconf" class="waves-effect waves-light btn">Here's your confirmation package.</a> <br>
        <a class="waves-effect waves-teal btn-flat">Name :</a>  <br>
        <a class="waves-effect waves-teal btn-flat">Destination :</a> <br>
        <a class="waves-effect waves-teal btn-flat">Address :</a> <br>
        <a class="waves-effect waves-teal btn-flat">Email : </a> <br>
        <a class="waves-effect waves-teal btn-flat">State : </a> <br>
        <a class="waves-effect waves-teal btn-flat">Zip Code : </a> <br>
